-- Script complet à exécuter en UNE SEULE FOIS dans phpMyAdmin
-- Onglet SQL ou Importer

-- Étape 1 : Créer la base de données
CREATE DATABASE IF NOT EXISTS campusconnect CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Étape 2 : Utiliser la base
USE campusconnect;

-- Étape 3 : Créer la table students
...
-- Étape 4 : Créer la table attendance
...
-- Étape 5 : Créer la table participation
...
-- Étape 7 : Insérer les données de test (seulement après avoir créé les tables)
